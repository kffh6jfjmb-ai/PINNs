# PINN-Van-del-Pol-Random-Fourier-Feature[van_test1.py](https://github.com/user-attachments/files/25590573/van_test1.py)
import numpy as np
...
model = PINN()
trained_model, loss_history = train_PINN(epochs=8000, model=model, mu=mu, T=T, x0=x0, v0=v0, w_ic=1000.0)
